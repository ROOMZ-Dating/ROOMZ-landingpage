  ...
  sections: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Marketing consent data: if you choose to opt in when joining a room, your opt-in choice, the phone number you provide for this purpose, and the date and time of your consent",
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [
              "Marketing Opt-in & Phone Number",
              "Shared with the relevant event organizer for their marketing communications — only if you explicitly opt in",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "To share your phone number with an event organizer for their marketing communications — only where you have given your explicit opt-in consent when joining that organizer's room",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "Marketing opt-in (optional). When you join a room, you may be offered the option to receive marketing communications from that room's event organizer. This is entirely optional, is turned off by default, and does not affect your ability to join or use the room. If — and only if — you explicitly opt in:",
        },
        {
          type: "list",
          items: [
            "Your phone number is shared with that specific event organizer. Your name and profile details are not included with it.",
            "The organizer may contact you with marketing communications, subject to applicable law and their own privacy practices. Once shared, the organizer acts as an independent controller of that phone number.",
            "Your consent applies only to the organizer of the room in which you gave it. Opting in for one room does not share your number with any other organizer.",
            "You may withdraw your consent at any time from the room's settings in the App or by contacting admin@roomzdating.com. Upon withdrawal, your number is removed from the organizer's exportable list, and we instruct the organizer to cease using it.",
          ],
        },
        {
          type: "p",
          text: "Organizers are contractually required to use shared phone numbers only in compliance with applicable law (including anti-spam and data protection laws), to honor opt-out requests, and not to sell or share these numbers with third parties.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Records of marketing consent (grant and withdrawal timestamps) are retained as evidence of lawful processing for as long as required by applicable law",
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Right to withdraw consent: withdraw any consent you have given (including marketing opt-in for event organizers) at any time, without affecting the lawfulness of processing before withdrawal",
